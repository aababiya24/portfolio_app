class ApplicationController < ActionController::Base
 ...
 #override configure_permitted_parameters method to allow additional parameters
   ...
   def configure_permitted_parameters
       ...
       devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :major, :expected_graduation_date, :image])
       # parameters that can be updated
       devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :major, :expected_graduation_date, :image])
   end
